...
import type { CalculateInput, CalculateResult } from '../../shared/types.ts'
...
export const ownerDepBySector: Record<string, number[]> = {
  restaurant_full: [-0.55, -0.28, 0, 0.18, 0.3],
  restaurant_fast: [-0.35, -0.18, 0, 0.12, 0.2],
  catering: [-0.65, -0.33, 0, 0.18, 0.3],
  food_mfg: [-0.85, -0.43, 0, 0.23, 0.38],
  bakery: [-0.55, -0.28, 0, 0.15, 0.25],
  retail_general: [-0.55, -0.28, 0, 0.15, 0.25],
  retail_specialty: [-0.65, -0.33, 0, 0.18, 0.3],
  liquor_store: [-0.4, -0.2, 0, 0.1, 0.18],
  auto_parts: [-0.55, -0.28, 0, 0.15, 0.25],
  gas_station: [-0.35, -0.18, 0, 0.1, 0.16],
  ecommerce_branded: [-0.9, -0.45, 0, 0.28, 0.5],
  ecommerce_amazon: [-0.65, -0.33, 0, 0.22, 0.38],
  hvac: [-1.1, -0.55, 0, 0.28, 0.45],
  plumbing: [-1.1, -0.55, 0, 0.28, 0.45],
  electrical: [-1.1, -0.55, 0, 0.28, 0.45],
  roofing: [-0.9, -0.45, 0, 0.23, 0.38],
  landscape_residential: [-1.0, -0.5, 0, 0.25, 0.4],
  landscape_commercial: [-0.65, -0.33, 0, 0.18, 0.28],
  pest_residential: [-0.65, -0.33, 0, 0.18, 0.3],
  pest_commercial: [-0.5, -0.25, 0, 0.15, 0.25],
  pool_service: [-0.6, -0.3, 0, 0.16, 0.27],
  cleaning_residential: [-0.65, -0.33, 0, 0.16, 0.25],
  cleaning_commercial: [-0.55, -0.28, 0, 0.14, 0.22],
  security_systems: [-0.65, -0.33, 0, 0.18, 0.3],
  painting: [-0.85, -0.43, 0, 0.2, 0.33],
  junk_removal: [-0.45, -0.23, 0, 0.13, 0.2],
  moving: [-0.6, -0.3, 0, 0.16, 0.25],
  appliance_repair: [-0.85, -0.43, 0, 0.2, 0.33],
  auto_repair: [-0.85, -0.43, 0, 0.2, 0.33],
  auto_body: [-0.85, -0.43, 0, 0.2, 0.33],
  car_wash: [-0.28, -0.14, 0, 0.08, 0.14],
  auto_dealer_new: [-0.38, -0.19, 0, 0.1, 0.18],
  auto_dealer_used: [-0.6, -0.3, 0, 0.16, 0.25],
  auto_rental: [-0.65, -0.33, 0, 0.18, 0.28],
  medical_primary: [-1.2, -0.62, 0, 0.32, 0.52],
  dental_general: [-2.5, -1.3, 0, 0.3, 0.5],
  dental_specialty: [-1.3, -0.68, 0, 0.32, 0.52],
  optometry: [-2.5, -1.3, 0, 0.28, 0.45],
  veterinary: [-2.5, -1.3, 0, 0.3, 0.48],
  physical_therapy: [-0.9, -0.45, 0, 0.25, 0.4],
  mental_health: [-1.0, -0.52, 0, 0.25, 0.4],
  aba_autism: [-0.8, -0.4, 0, 0.22, 0.35],
  med_spa: [-1.0, -0.52, 0, 0.25, 0.4],
  home_health: [-0.75, -0.38, 0, 0.2, 0.33],
  hospice: [-0.75, -0.38, 0, 0.2, 0.33],
  fitness: [-0.75, -0.38, 0, 0.2, 0.33],
  pharmacy: [-0.45, -0.23, 0, 0.13, 0.2],
  cpa_accounting: [-2.2, -1.1, 0, 0.32, 0.52],
  law_general: [-2.5, -1.3, 0, 0.32, 0.52],
  law_pi: [-2.5, -1.3, 0, 0.32, 0.52],
  engineering: [-2.3, -1.2, 0, 0.32, 0.5],
  msp: [-0.8, -0.4, 0, 0.25, 0.42],
  marketing_agency: [-2.5, -1.3, 0, 0.32, 0.52],
  pr_firm: [-2.3, -1.2, 0, 0.32, 0.52],
  mgmt_consulting: [-2.3, -1.2, 0, 0.35, 0.55],
  staffing: [-0.7, -0.35, 0, 0.18, 0.3],
  insurance_pc: [-2.2, -1.1, 0, 0.28, 0.45],
  insurance_life: [-2.2, -1.1, 0, 0.28, 0.45],
  wealth_mgmt: [-2.5, -1.3, 0, 0.32, 0.5],
  mortgage: [-2.0, -1.0, 0, 0.25, 0.4],
  title_escrow: [-0.55, -0.28, 0, 0.15, 0.23],
  appraisal: [-2.2, -1.1, 0, 0.25, 0.4],
  saas: [-0.65, -0.33, 0, 0.28, 0.9],
  it_services: [-0.8, -0.4, 0, 0.23, 0.9],
  custom_software: [-2.0, -1.0, 0, 0.28, 0.9],
  tech_staffing: [-0.65, -0.33, 0, 0.18, 0.28],
  digital_marketing: [-1.4, -0.78, 0, 0.3, 0.48],
  cybersecurity: [-0.85, -0.43, 0, 0.25, 0.9],
  data_analytics: [-0.95, -0.48, 0, 0.25, 0.9],
  manufacturing: [-0.85, -0.43, 0, 0.22, 0.35],
  mfg_specialty: [-0.95, -0.48, 0, 0.25, 0.4],
  food_processing: [-0.85, -0.43, 0, 0.22, 0.35],
  machine_shop: [-0.95, -0.48, 0, 0.23, 0.38],
  distribution: [-0.65, -0.33, 0, 0.18, 0.3],
  distribution_specialty: [-0.75, -0.38, 0, 0.2, 0.32],
  industrial_services: [-0.75, -0.38, 0, 0.2, 0.32],
  gc_commercial: [-1.05, -0.53, 0, 0.25, 0.42],
  gc_residential: [-0.95, -0.48, 0, 0.23, 0.38],
  contractor_mep: [-0.95, -0.48, 0, 0.23, 0.38],
  contractor_other: [-0.85, -0.43, 0, 0.2, 0.33],
  real_estate_brokerage: [-2.5, -1.3, 0, 0.28, 0.45],
  property_mgmt: [-0.55, -0.28, 0, 0.15, 0.23],
  real_estate_appraisal: [-2.2, -1.1, 0, 0.25, 0.4],
  commercial_cleaning: [-0.5, -0.25, 0, 0.13, 0.2],
  trucking_asset: [-0.65, -0.33, 0, 0.18, 0.3],
  freight_brokerage: [-0.85, -0.43, 0, 0.22, 0.35],
  last_mile: [-0.55, -0.28, 0, 0.15, 0.23],
  moving_transport: [-0.65, -0.33, 0, 0.16, 0.25],
  warehousing: [-0.55, -0.28, 0, 0.15, 0.23],
  auto_transport: [-0.55, -0.28, 0, 0.15, 0.23],
  childcare: [-0.75, -0.38, 0, 0.2, 0.32],
  private_school: [-0.85, -0.43, 0, 0.22, 0.35],
  tutoring: [-0.95, -0.48, 0, 0.23, 0.38],
  vocational_school: [-0.75, -0.38, 0, 0.2, 0.32],
  elearning: [-0.65, -0.33, 0, 0.23, 0.9],
  assisted_living_small: [-0.95, -0.48, 0, 0.23, 0.38],
  assisted_living_large: [-0.7, -0.35, 0, 0.18, 0.3],
  home_care_private: [-0.8, -0.4, 0, 0.2, 0.33],
  adult_day: [-0.7, -0.35, 0, 0.18, 0.3],
  hair_salon: [-0.85, -0.43, 0, 0.2, 0.33],
  day_spa: [-0.85, -0.43, 0, 0.2, 0.33],
  tattoo: [-1.05, -0.53, 0, 0.23, 0.38],
  funeral_home: [-0.65, -0.33, 0, 0.16, 0.25],
  event_planning: [-1.05, -0.53, 0, 0.23, 0.38],
  photography: [-1.15, -0.58, 0, 0.25, 0.4],
  landscaping_design: [-0.95, -0.48, 0, 0.23, 0.38],
  tree_service: [-0.85, -0.43, 0, 0.2, 0.33],
  environmental: [-0.95, -0.48, 0, 0.23, 0.38],
  waste_mgmt: [-0.55, -0.28, 0, 0.16, 0.25],
  irrigation: [-0.75, -0.38, 0, 0.18, 0.3],
  nursery: [-0.65, -0.33, 0, 0.16, 0.25],
  publishing: [-2.0, -1.0, 0, 0.28, 0.45],
  printing: [-0.75, -0.38, 0, 0.18, 0.3],
  other: [-0.85, -0.43, 0, 0.2, 0.33],
}
...
const industryCategoryMap: Record<string, string> = {
  ...
  msp: 'Technology', marketing_agency: 'Professional Services',
